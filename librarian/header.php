                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="return_book.php"><i class="fa fa-bar-chart-o"></i> Rrturn Books <span
                                    class="fa fa-chevron-down"></span></a>
                            ...
                            </li><li><a href="send_notification_student.php"><i class="fa fa-mail-forward"></i> Send Message To Student <span
                                    class="fa fa-chevron-down"></span></a>
